...
function LoginScreen({ control, errors, loading, onLogin, onGoogleLogin }: LoginScreenProps) {
  return (
    <KeyboardAvoidingView
      ...
      className="flex-1 justify-center bg-linear-30 from-[#F9F9F9] to-[#8e8ede]">
      <SafeAreaView className="">
        <View className="justify-center px-8 py-12">
          {/* Header */}
          <View className="mb-12">
            <Text className="text-center text-3xl font-bold text-[#0D0C22]">Sign in to Blog</Text>
          </View>
          ...
          <Pressable
            ...
            <Text className="ml-3 text-base font-semibold text-[#0D0C22]">Sign in with Github</Text>
          </Pressable>
            ...
            <View>
              <View className="mb-2 flex-row items-center justify-between">
                ...
                <Link href="/(auth)/forgot-password" asChild>
                  <Pressable>
                    <Text className="text-sm text-[#6E6D7A] underline">Forgot password?</Text>
                  </Pressable>
                </Link>
              </View>
              <Controller
