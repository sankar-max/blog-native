			...
			<SafeAreaView className="flex-1" edges={["bottom", "left", "right"]}>
				...
				>
					...
					<View className="flex-row items-center gap-4 justify-between">
						...
						<View className="flex-row ml-auto items-center gap-1">
							<PressableBtn
								style={{
									display: "flex",
									alignItems: "center",
							...
							>
								...
								/>
								<Text className="">{post.totalLikes}</Text>
							</PressableBtn>
						</View>
						<View className="flex-row items-center gap-1">
							<PressableBtn onPress={() => toggleLikePost(post.id)}>
								<MessageCircle size={16} />
							</PressableBtn>
							<Text className="">{post.totalComments}</Text>
						</View>
					</View>
